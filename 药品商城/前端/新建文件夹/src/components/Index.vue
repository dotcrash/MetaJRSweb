...
<m-header></m-header>
    ...
    <div class="content">
      ...
      <div class="seckill">
        <!-- 头部 -->
        <!-- <div class="seckill-head" style="border-radius: 10px" >
          <div class="seckill-icon">
            <img src="static/img/index/clock.png">
          </div>
          <div class="seckill-text"  style="width: 600px;">
			  <span class="seckill-title">爱脑健康商城</span>
            <span class="seckill-title" style="font-size: medium;">           限时秒杀</span>
            <span class="seckill-remarks" style="width: 600px;">总有你想不到的低价</span>
          </div>
        ...
        <div class="seckill-content" >
			<div class="item-class"style=" height: 100px;border-radius: 10px">
						  <div class="item-class-head"  style="border-radius: 10px" >
								<span class="item-class-title">{{computer.title}}</span>
								  <ul  style=" border-radius: 10px">
									  <li v-for="(item, index) in computer.link" :key="index" >
										<router-link to="/goodsList" style=" border-radius: 10px">{{item}}</router-link>
									  </li>
								  </ul>
								  </span>
						 </div>
...
export default {
  name: 'index',
  components:{forumHeader,forumFooter,forumMain,mheader},
  created () {

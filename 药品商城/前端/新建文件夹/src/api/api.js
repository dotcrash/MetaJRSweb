...
export const loginApi = (params) => { return axios.post(`${api}/front/login`, params) };  //登录
...
export const getUserInfo = (params) => { return axios.get(`${api}/front/login`, { params }) }; // 获取个人信息

...
<template>
  <div class="home_wrap">
    ...
    <div class="goods-list-container">
      ...
      <el-table border ref="selection"  :data="shoppingCart" size="large" @on-selection-change="select" no-data-text="您的购物车没有商品，请先添加商品到购物车再点击购买">
		          ...
		          <el-table-column prop="title" label="商品简介" width="195px"></el-table-column>
		          <el-table-column prop="package" label="商品套餐" width="170px"></el-table-column>
		          <el-table-column prop="count" label="商品数量" width="120px"/>

  ...
  data() {
    return {
     articleData: {
     	  ...
     	  "title":"脑系疾病的自述","readNum": 20,"commentNum":20,"likeNum":20,"createdTime":"2022-05-06",
     	  "contentHtml":"       我父亲去年突发脑中风，到时情况非常的严重。幸亏我母亲发现及时，送去医院经过大夫8个小时的手术抢救才没有生命危险。可是2天后，父亲醒来的时候发现发起到不能说话、右手臂没有知觉。当时赶紧找来了大夫，大夫检查之后诊断为是中风偏瘫。\r\n       大夫告诉我说偏瘫是由于控制肢体协调一致的运动程序紊乱引起的，因此关键是恢复高位中枢重新支配肢体的功能。当时大夫建议在他医院接受神经训导康复。当时我们也同意，之后的治疗全面都是大夫负责进行的。效果还真的不错，在康复半年后，我们能明显感觉到父亲的状况好多了。接下来我们还是在继续治疗下去，相信有一天一定能好起来的，我相信大夫的能力。",
     	  "articleImg":"/static/img/content/1.jpg"
       },
       timer: null,
       commentNum: 3,
       userInfo: {"_id":1,"nickname":"爱开发的小罗","avatar": "/static/img/avatar/1.jpg","experience":""},
       totalRaticleReadLike: [{"name":"总浏览量","value":"20"},{"name":"点赞总数","value":"20"},{"name":"文章总数","value":"20"}],
       likeForm: {
         status: false,
         form: {
           articleId: this.$route.params.id,
